...
export const quickFillers: Activity[] = [
  ...
  {
    id: "silent-thirty",
    title: "The Silent Thirty",
    description: "Thirty seconds of total silence, and if anyone breaks it the clock restarts.",
    instructions: [
      "Thirty seconds. Complete silence. That's it.",
      "Any noise at all, the clock goes back to thirty.",
      "Don't explain why. Just do it.",
      "When they make it, say 'right' and move on.",
    ],
    duration: 45,
    energy: "calm",
    noise: "quiet",
    ...
    equipment: ["timer"],
    yearLevels: ["early-primary", "upper-primary", "years-7-9", "years-10-12"],
    categories: ["kill-time", "calm-down"],
    tags: ["silent", "settling", "quick", "no-prep"],
  },
  {
  ...
  },
  {
    id: "thumbs-check",
    title: "Thumbs Check",
    description: "A thirty-second read of how confident the room actually is.",
    instructions: [
      "Thumbs up if you've got this, sideways if you're shaky, down if you're lost.",
      "Everyone at once, on three, and be honest.",
      "Look around — count the sideways and down.",
      "That number decides what happens next lesson.",
    ],
    duration: 30,
    energy: "calm",
    noise: "quiet",
    ...
    equipment: ["none"],
    yearLevels: ["early-primary", "upper-primary", "years-7-9", "years-10-12"],
    categories: ["kill-time", "curriculum", "calm-down"],
    tags: ["assessment", "quick", "no-prep", "reflection"],
  },
  {
    id: "clap-if-true",
